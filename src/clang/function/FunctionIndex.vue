...
import FunctionMotivation from "./FunctionMotivation.vue";
import FunctionDefinition from "./FunctionDefinition.vue";
import FunctionExample from "./FunctionExample.vue";
import FunctionCall from "./FunctionCall.vue";
import FunctionTips from "./FunctionTips.vue";
import ReturnStatement from "./ReturnStatement.vue";
import Fibonacci from "./Fibonacci.vue";
import CallingProcess from "./CallingProcess.vue";
const show=ref(false);

let componentList=[Appearance,FunctionMotivation,FunctionIntroduction,FunctionDefinition,FunctionExample,
ReturnStatement,FunctionCall,FunctionTips,Fibonacci,CallingProcess
];
const index=ref(0);
...
<template>
    <nav v-show="show">
        <ul>
            ...
            <li>
                <router-link to="/clang/function">第10章 </router-link>
            </li>
        </ul>
