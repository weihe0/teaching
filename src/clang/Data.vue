  ...
  <CLangLayout>
    ...
    <CSlide title="取变量名的规则">
      <ul>
        ...
        <li>不合法的变量名：<span class="counterexample">123number</span>，<span class="counterexample">your name</span>
        </li>
      </ul>
    </CSlide>
    <CSlide title="取变量名的推荐做法">
      <ul style="width: 80%">
    ...
    <CSlide title="整数类型">
      <table>
        <tr>
          <td><span class="omit">signed</span> short <span class="omit">int</span></td>
        ...
        <tr>
          <td><span class="omit">signed</span> long <span class="omit">int</span></td>
