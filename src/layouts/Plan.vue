...
const props=defineProps<{
  ...
  topic: string, keynote: string, difficulty: string,
}>()
...
<template>
  ...
  <div class='plan'>
    ...
    <div class='body'>
      ...
      <slot name='body'></slot>
      <span class='head'>重点：</span><span>{{props.keynote}}</span><br/>
      <span class='head'>难点：</span><span>{{props.difficulty}}</span><br/>
    </div>
    <div>
