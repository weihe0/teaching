...
b = t;</code></pre>
    ...
    <Slide title="算术表达式实例">
      <p>苹果公司的CEO来中国考察。他是美国人，使用华氏温度。摄氏温度<InlineMath tex={'c'}/>与华氏温度<InlineMath tex={'f'}/>的转换公式为
        <InlineMath tex={'f=\\frac{9}{5}c+32, c=\\frac{5}{9}(f-32)'}/></p>
    </Slide>
    <Slide title="程序要求">
      <p>输入一个摄氏温度<InlineMath tex={'c'}/>，得到华氏温度，再输入一个华氏温度<InlineMath tex={'f'}/>，得到摄氏温度</p>
      <p>如果程序正确，那么当<InlineMath tex={'c=20'}/>时，<InlineMath tex={'f={{9/5*20+32}}'}/>，
        当<InlineMath tex={'f={{9/5*20+32}}'}/>时，<InlineMath tex={'c={{5/9*(68-32)}}'}/></p>
    </Slide>
    <Slide title="关系运算符">
      <div>
