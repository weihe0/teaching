...
const slides:Component[]=[
  {
    render(){
      return <Slide title="第7章 运算符与表达式">
        <ol>
          <li>赋值运算符与赋值表达式</li>
          <li>算术运算符与算术表达式</li>
          <li>自增自减运算符</li>
  ...
  {
    render(){
      return <Slide title="用赋值运算交换变量的值">
      <pre><code>int t = a;
a = b;
b = t;</code></pre>
  ...
  {
    render(){
      return <Slide title="赋值运算中的强制类型转换">
        <ul>
  ...
  {
    render(){
      return <Slide title="unsigned运算超范围的处理">
  ...
  {
    render(){
      return <Slide title="算术表达式实例">
        <p>苹果公司的CEO来中国考察。他是美国人，使用华氏温度。摄氏温度<Math tex={'c'}/>与华氏温度<Math tex={'f'}/>的转换公式为
          <Math tex={'f=\\frac{9}{5}c+32, c=\\frac{5}{9}(f-32)'}/></p>
      </Slide>
    }
  },
  {
    render(){
      return <Slide title="程序要求">
        <p>输入一个摄氏温度<Math tex={'c'}/>，得到华氏温度，再输入一个华氏温度<Math tex={'f'}/>，得到摄氏温度</p>
        <p>如果程序正确，那么当<Math tex={'c=20'}/>时，<Math tex={'f={{9/5*20+32}}'}/>，
          当<Math tex={'f={{9/5*20+32}}'}/>时，<Math tex={'c={{5/9*(68-32)}}'}/></p>
      </Slide>
    }
  },
  {
    render(){
      return <Slide title="关系运算符">
        <div>
          <code>int a = <input type="number"/>;
            int b = <input type="number"/>;</code></div>
        <table>
          <thead><tr><td>表达式</td><td>值</td><td>表达式</td><td>值</td></tr></thead>
          <tbody>
          <tr><td><code>a&gt;b</code></td><td></td>
            <td><code>a&lt;b</code></td><td></td>
          </tr>
          <tr><td><code>a&gt;=b</code></td><td></td>
            <td><code>a&lt;=b</code></td><td></td>
          </tr>
  ...
  {
    render(){
      return <Slide title="逻辑运算符">
        <div>
          <code>int a = <input type="number"/>;<br/>
        ...
        <table>
          ...
          <tbody>
          <tr><td><code>a&&b</code></td><td></td></tr>
          <tr><td><code>a||b</code></td><td></td></tr>
          <tr><td><code>!c</code></td><td></td></tr>
          </tbody>
        </table>
      </Slide>
    }
...
int c = 5;</code></pre>
        <ul>
          <li><code>a &gt; b && <span>b &gt; c</span></code>中，由于<code>&&</code>前面已经计算为假，
            后面<em>不执行</em></li>
