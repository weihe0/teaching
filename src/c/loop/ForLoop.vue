...
<template>
    <section class="slide">
        <h1 class="title">for循环</h1>
        <div class="execution">
            <p class="code">
                <span>int s=0;</span><br/>
                <span>for(<span :class="{running: runStates[0]}">int i=1</span>;
                <span :class="{running: runStates[1]}">i&lt;=5</span>;
                <span :class="{running: runStates[3]}">i++</span>) {</span><br/>
