...
<template>
  <Paper>
    ...
    <section>
      <h2>工业机器人介绍</h2>
      <p>机器人(Robot)是自动执行工作的机器装置。它既可以接受人类指挥，又可以运行预先编排的程序，
        ...
        在运动控制方面PLC 可以用于圆周运动或直线运动的控制。利用PLC程序控制可以实现机械手的控制要求。
    ...
    <section>
      <h2>设定工具坐标系</h2>
      <p>华数机器人主要包括三大组成部分： 机器人本体、电气控制柜、示教器 。
        机器人控制器一般安装于机器人电柜内部，控制机器人的伺服驱动器、输入输出等主要执行设备；
        机器人示教器一般通过电缆连接到机器人电柜上，作为上位机通过以太网与控制器进行通讯</p>
      <img src='/training/bot.png'/>
      <img src='/training/axis.png'/><br/>
      <table class='description'>
        <thead>
        <tr><th>序号</th><th>功能</th></tr>
        </thead>
        <tbody>
        <tr><td>1</td><td>切换运行模式</td></tr>
        <tr><td>2</td><td>紧急停止</td></tr>
        <tr><td>3</td><td>手动运行</td></tr>
        <tr><td>4</td><td>程序调节量</td></tr>
        <tr><td>5</td><td>手动调节量</td></tr>
        <tr><td>6</td><td>菜单</td></tr>
        <tr><td>7</td><td>暂停</td></tr>
        <tr><td>8</td><td>停止</td></tr>
        <tr><td>9</td><td>预留按键</td></tr>
        <tr><td>10</td><td>自动运行</td></tr>
        <tr><td>11</td><td>输入输出</td></tr>
        </tbody>
      </table>
      <figure>
