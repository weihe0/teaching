...
const slides: Component[] = [
    ...
    render() {
      return (
        <Slide title="智能家居案例（非真实）">
          <ul>
            <li>
              <a href="https://www.bilibili.com/video/BV1Ft411V78z" target="_blank">
                Q宝
              </a>
            </li>
            <li>
              <a href="https://www.bilibili.com/video/BV1E7411f7WH" target="_blank">
                罗宝
              </a>
            </li>
            <li>
              <a href="https://www.bilibili.com/video/BV1Sv4y1V7Xb" target="_blank">
                马宝
              </a>
            </li>
            <li>
              <a href="https://www.bilibili.com/video/BV1KE411F7Re" target="_blank">
                茄宝
              </a>
            </li>
          </ul>
  ...
  },
  {
    render() {
      return (
        <Slide title="智能家居生活">
          <a href="https://www.bilibili.com/video/BV1aW4y1877E" target="_blank">
            <p>Alexa</p>
          </a>
        </Slide>
      )
