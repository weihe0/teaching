...
import {onMounted, onUnmounted, ref, VueElement, watch, watchEffect} from "vue";
import Slide from "../../components/Slide.vue";
import Contents from "./Contents.vue";
import Concepts from "./Concepts.vue";
import Features from "./Features.vue";
import Advantages from "./Advantages.vue";
import Surveillance from "./Surveillance.vue";
import ETC from "./ETC.vue";
import Yolo from "./Yolo.vue";
import Data from "./Data.vue";
import YoloNetwork from "./YoloNetwork.vue";
import AutoDrive from "./AutoDrive.vue";
const show=ref(false);

let componentList=[Contents,Concepts,Features,Advantages,Surveillance,ETC,AutoDrive,Data,Yolo,YoloNetwork];
const index=ref(0);
